        ...
        <ThemeProvider>
          ...
          <header className="border-b border-[var(--border)] sticky top-0 z-10 bg-[var(--background)] backdrop-blur">
            <div className="max-w-4xl mx-auto px-4 py-3 flex items-center gap-3">
              ...
              <span className="text-xs text-[var(--muted)] font-mono hidden md:inline shrink-0">Intermediate B1 · Busuu</span>

              {/* Spacer */}
              <div className="flex-1" />

              {/* Right: nav links (scrollable on very narrow screens) + theme */}
              <nav className="flex items-center gap-2 overflow-x-auto scrollbar-hide">
                ...
                <Link href="/sounds" className="text-xs px-2.5 py-1 rounded-full border border-[var(--border)] text-[var(--muted)] hover:text-[var(--foreground)] hover:border-[var(--muted)] transition-colors shrink-0">
                  🎧 Sounds
                </Link>
              </nav>
              <ThemeSwitcher />
